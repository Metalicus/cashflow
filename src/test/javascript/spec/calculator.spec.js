...
describe('Calculator tests', function () {
    ...
    describe('CalculatorCtrl', function () {
        ...
        it('should remove decimal mark if operation pressed before adding number', function () {
            expect($scope.model.decimal).toEqual(false);
            $scope.pressDecimalMark();
            expect($scope.model.decimal).toEqual(true);
            expect($scope.model.secondNumber).toEqual('');
        ...
        it('rounds to 2 digits', function () {
            $scope.model.firstNumber = '2365242.12';
            $scope.model.setOperation(CALC_OPERATION.ADD);
            $scope.model.secondNumber = '45554.14';
            $scope.model.decimal = true;
            $scope.model.calculate();
            expect($scope.model.firstNumber).toEqual('2410796.26');
        });
