package ru.metal.cashflow.server.hibernate;
...
/**
 * Hibernate still not supports Java 8 time api
 *
 * @see <a href="http://blog.progs.be/550/java-time-hibernate">http://blog.progs.be/550/java-time-hibernate</a>
 */
